...
class AndroidlargefiveItemWidget extends StatelessWidget {
  AndroidlargefiveItemWidget(
    this.androidlargefiveItemModelObj, {
    Key? key,
    this.onTapFrame,
  }) : super(
          key: key,
  ...
  AndroidlargefiveItemModel androidlargefiveItemModelObj;
              ...
              children: [
                Column(
                  ...
                  children: [
                    Obx(
                      () => Text(
                        androidlargefiveItemModelObj.cakeOne!.value,
                        style: theme.textTheme.bodyLarge,
                      ),
                    ),
                    Obx(
                      () => Text(
                        androidlargefiveItemModelObj.oneHundredFifty!.value,
                        style: theme.textTheme.bodyLarge,
                      ),
                    ),
                  ],
